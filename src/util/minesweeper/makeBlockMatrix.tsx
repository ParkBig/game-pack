import { BlockInfo, BlockInfoRow } from 'types/store/useMinesweeperStateTypes';
...
const exchangeBlockInfo = (board: BlockInfoRow[], source: [number, number], target: [number, number]) => {
  ...
  board[sourceRow][sourceCol] = { ...sourceBlock, isMine: false };
  board[targetRow][targetCol] = { ...targetBlock, isMine: true };
};
